...
if (XRegExp = XRegExp || function(e) {
    ...
    function i(e, i, o) {
        ...
        return o && (r = f.replace.call(r, new RegExp("[" + o + "]+","g"), "")),
        e = e.xregexp && !e.xregexp.isNative ? t(u(e.source, r), e.xregexp.captureNames ? e.xregexp.captureNames.slice(0) : null) : t(new RegExp(e.source,r), null, !0)
    }
    function o(e, t) {
        var n = e.length;
    ...
    function a(e) {
        ...
        "all" === e || e.all ? e = {
            natives: !0,
            extensibility: !0
        } : r(e, "string") && (e = u.forEach(e, /[^\s,]+/, function(e) {
            this[e] = !0
        }, {})),
        e
    }
    function s(e, t, n, i) {
        var o, r, a = v.length, s = null;
        E = !0;
        try {
            for (; a--; )
                if (r = v[a],
                ("all" === r.scope || r.scope === n) && (!r.trigger || r.trigger.call(i)) && (r.pattern.lastIndex = t,
    ...
    }, p = {}, m = {}, v = [], w = "default", b = "class", y = {
        "default": /^(?:\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9]\d*|x[\dA-Fa-f]{2}|u[\dA-Fa-f]{4}|c[A-Za-z]|[\s\S])|\(\?[:=!]|[?*+]\?|{\d+(?:,\d*)?}\??)/,
        "class": /^(?:\\(?:[0-3][0-7]{0,2}|[4-7][0-7]?|x[\dA-Fa-f]{2}|u[\dA-Fa-f]{4}|c[A-Za-z]|[\s\S]))/
    }, A = /\$(?:{([\w$]+)}|(\d\d?|[\s\S]))/g, C = /([\s\S])(?=[\s\S]*\1)/g, F = /^(?:[?*+]|{\d+(?:,\d*)?})\??/, k = f.exec.call(/()??/, "")[1] === e, D = RegExp.prototype.sticky !== e, E = !1, B = "gim" + (D ? "y" : "");
    return u = function(n, o) {
        ...
        for (n = f.replace.call(n, /^\(\?([\w$]+)\)/, function(e, t) {
            if (f.test.call(/[gy]/, t))
        ...
        u.forEach(o, /[\s\S]/, function(e) {
            ...
            r = s(n, g, d, h),
            r ? (c.push(r.output),
            g += r.match[0].length || 1) : (a = f.exec.call(y[d], n.slice(g)),
            a ? (c.push(a[0]),
            g += a[0].length) : (l = n.charAt(g),
            "[" === l ? d = b : "]" === l && (d = w),
            c.push(l),
            ++g));
        return t(new RegExp(c.join(""),f.replace.call(o, /[^gimy]+/g, "")), h.hasNamedCapture ? h.captureNames : null)
    }
    ,
    d = {
        on: function(e, t, n) {
    ...
    u.exec = function(e, t, n, o) {
        var r, a = i(t, "g" + (o && D ? "y" : ""), o === !1 ? "y" : "");
        return a.lastIndex = n = n || 0,
        r = p.exec.call(a, e),
    ...
    u.replace = function(t, n, o, r) {
        var a, s = u.isRegExp(n), l = n;
        return s ? (r === e && n.global && (r = "all"),
        l = i(n, "all" === r ? "g" : "", "all" === r ? "" : "g")) : "all" === r && (l = new RegExp(u.escape(String(n)),"g")),
    ...
    u.union = function(e, t) {
        var n, i, o, a, s = /(\()(?!\?)|\\([1-9]\d*)|\\[\s\S]|\[(?:[^\\\]]|\\[\s\S])*]/g, l = 0, c = function(e, t, o) {
            var r = i[l - n];
            if (t) {
                if (++l,
                r)
        ...
        for (a = 0; a < e.length; ++a)
            ...
            d.push(u(o.source).source.replace(s, c))) : d.push(u.escape(o));
        return u(d.join("|"), t)
    }
    ,
    u.version = "2.0.0",
    p.exec = function(t) {
        ...
        i = f.exec.apply(this, arguments)) {
            if (!k && i.length > 1 && o(i, "") > -1 && (a = new RegExp(this.source,f.replace.call(n(this), "g", "")),
            ...
            this.xregexp && this.xregexp.captureNames)
                for (l = 1; l < i.length; ++l)
                    r = this.xregexp.captureNames[l - 1],
                    r && (i[r] = i[l]);
    ...
    p.replace = function(e, t) {
        var n, i, a, s, l = u.isRegExp(e);
        return l ? (e.xregexp && (n = e.xregexp.captureNames),
        e.global || (s = e.lastIndex)) : e += "",
        r(t, "function") ? i = f.replace.call(String(this), e, function() {
            var i, o = arguments;
            if (n)
                for (o[0] = new String(o[0]),
                i = 0; i < n.length; ++i)
                    n[i] && (o[0][n[i]] = o[i + 1]);
            return l && e.global && (e.lastIndex = o[o.length - 2] + o[0].length),
            t.apply(null, o)
        }) : (a = String(this),
    ...
    p.split = function(t, n) {
        if (!u.isRegExp(t))
            return f.split.apply(this, arguments);
        var i, o = String(this), r = t.lastIndex, a = [], s = 0;
        return n = (n === e ? -1 : n) >>> 0,
        u.forEach(o, t, function(e) {
            e.index + e[0].length > s && (a.push(o.slice(s, e.index)),
            e.length > 1 && e.index < o.length && Array.prototype.push.apply(a, e.slice(1)),
            i = e[0].length,
            s = e.index + i)
        }),
        s === o.length ? (!f.test.call(t, "") || i) && a.push("") : a.push(o.slice(s)),
        t.lastIndex = r,
    ...
    h(/\\(\d+)/, function(e, t) {
        if (!(t === w && /^[1-9]/.test(e[1]) && +e[1] <= this.captureNames.length) && "0" !== e[1])
...
function(e) {
    ...
    function a(t) {
        ...
        return e.forEach(t, /\\u(\w{4})(?:-\\u(\w{4}))?/, function(e) {
            n = o(e[1]),
            n > s + 1 && (a.push("\\u" + i(r(s + 1))),
            n > s + 2 && a.push("-\\u" + i(r(n - 1)))),
            s = o(e[2] || e[1])
        }),
        65535 > s && (a.push("\\u" + i(r(s + 1))),
        65534 > s && a.push("-\\uFFFF")),
        a.join("")
    }
    function s(e) {
    ...
    e.addUnicodePackage = function(i, o) {
        ...
        if (i)
            for (r in i)
                i.hasOwnProperty(r) && (l[t(r)] = n(i[r]));
        if (o)
            for (r in o)
                o.hasOwnProperty(r) && (l[t(o[r])] = l[t(r)])
    }
    ,
    e.addUnicodePackage({
  ...
  var a = new n("[\\p{Han}\\p{Hiragana}\\p{Katakana}\\p{Thai}]")
    ...
    if (a.test(n)) {
      for (var h = "", g = 0; g < n.length; g++) {
        for (u = "<span data-p=" + r++ + ">",
               d = "</span>",
               h += u + n[g]; g < n.length - 1 && s.test(n[g + 1]); )
          g++,
            h += n[g];
        h += d,
          o += u.length + d.length
