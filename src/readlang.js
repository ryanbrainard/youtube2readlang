...
readlang.buildApiRequest = (method, path, others) =>
  Object.assign(
    {
      method,
      ...
      handleResponse: function(response) {
        // TODO: this shouldn't be needed, but react-refetch isn't reseting to default after XML override
        if (
...
readlang.login = function(force) {
  ...
  window.location.href = readlang.url(
    '/oauth?response_type=token&client_id=' +
      config.APIKey +
      '&redirect_uri=' +
